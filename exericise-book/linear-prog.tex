...
% 	Доход & 20 & 12 & 4 & 2 &  \\ \hline
% \end{tabular}
% \end{center}
% Предполагается, что нормы затрат постоянны и цены экзогенны.

% Постройте модель оптимизации производства и двойственную задачу.
% Решите двойственную задачу и найдите оптимальное производство.
% \end{exercise}
...
% Предполагается, что нормы затрат постоянны и цены экзогенны.
% \begin{enumerate}[i)]
% 	\item Постройте модель оптимизации производства.
% 	\item Постройте двойственную задачу.
% 	\item Найдите оптимальное производство.
...
% Постройте модель оптимизации производства и найдите
% оптимальные объемы производства.
% Какой ресурс используется полностью, а какой не полностью?
% \end{exercise}
...
%  \item Постройте двойственную задачу.
%  \item Найдите оптимальнго количество ресурсов.
%  \item Найдите решение двойственной задачи и дайте
%  экономическую интерпретацию этого решения.
% \end{enumerate}
% \end{exercise}
...
% Санкт-Перербург -- 140 кг, Нижний Новгород -- 120 кг. Компания
% АЛРОСА раполагает тремя месторождениями: <<Мирное>>, <<Удачный>> и
...
%   Склады & <<Ашан>> & <<Карусель>> & <<7 Континет>> & <<Арбатский>> &
%   Запасы, уп.
%   \\ \hline
